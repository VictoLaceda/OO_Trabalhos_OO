...
@WebServlet("/pegaporano")
public class PegaPorAno extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Element livro=manipulador.pegaLivroPorAno(Integer.parseInt(request.getParameter("ano")),request.getParameter("operador"));
            if(livro==null)
